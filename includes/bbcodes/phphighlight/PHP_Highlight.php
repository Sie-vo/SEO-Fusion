...
class PHP_Highlight {
	...
	function __construct($inline = FALSE) {
		...
		if ($inline === FALSE) {
			...
			$this->highlight = array('string' => ini_get('highlight.string'), 'comment' => ini_get('highlight.comment'),
			...
			// Basic styles
			$this->highlight = array('string' => 'string', 'comment' => 'comment', 'keyword' => 'keyword', 'bg' => 'bg',
