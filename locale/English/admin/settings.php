...
$locale['458'] = "Time";
$locale['459'] = "default timezone";
//$locale['460'] = "You"; // not used anymore
//$locale['461'] = "Guests"; // not used anymore
//$locale['462'] = "Server offset"; // not used anymore
//$locale['463'] = "Set this so server time is GMT 0"; // not used anymore
...
// strftime removed for PHP 8.1 compatibility, we should use date format from now on
