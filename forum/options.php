...
if (!isset($_GET['thread_id']) || !isnum($_GET['thread_id'])) { redirect(seo_url("index.php"))	; }
...
if (isset($_POST['canceldelete'])) { redirect(seo_url('forum_thread', $_GET['thread_id'])); }
...
if (isset($_GET['step']) && $_GET['step'] == "renew") {
	...
	if (dbrows($result)) {
		...
		echo "<a href='".seo_url('forum_forum', $_GET['forum_id'])."'>".$locale['402']."</a><br /><br />\n";
