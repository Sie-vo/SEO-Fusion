...
if ($rows) {
	...
	while ($data = dbarray($result)) {
		...
		echo "<td width='100%' class='".$row_color."'><a href='".seo_url('forum_thread', $data['thread_id'], ['pid' => $data['post_id']])."#post_".$data['post_id']."' title='".$data['thread_subject']."'>".trimlink($data['thread_subject'], 40)."</a></td>\n";
