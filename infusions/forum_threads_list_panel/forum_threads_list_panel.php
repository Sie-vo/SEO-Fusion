...
if (dbrows($result)) {
	...
	while ($data = dbarray($result)) {
		...
		echo "</td>\n";
		echo "<td width='100%' class='".$row_color."'>".$thread_poll."<a href='".seo_url('forum_thread', $data['thread_id'], ['pid' => $data['thread_lastpostid']])."#post_".$data['thread_lastpostid']."' title='".$data['thread_subject']."'>".trimlink($data['thread_subject'], 30)."</a><br />\n".$data['forum_name']."</td>\n";
